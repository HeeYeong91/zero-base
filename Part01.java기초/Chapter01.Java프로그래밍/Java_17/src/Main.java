...
//      1-2. 컬렉션 스트림
        ...
        System.out.println("== to Stream ==");
        Stream strea2 = list1.stream();
//        strea2.forEach(System.out::println); // 1 2 3
        strea2.forEach(num -> System.out.println("num = " + num)); // num = 1 num = 2 num = 3
...
//      1-6. 기본 타입 스트림
        ...
        IntStream intStream = IntStream.range(1, 5); // 1부터 4
...
//      2-1. Filtering
        ...
        IntStream intStream2 = IntStream.range(1, 10).filter(n -> n % 2 == 0); // 짝수
...
//      2-3. Sorting
        ...
        intStreamSort.forEach(System.out::println); // 1 2 3 4 5
